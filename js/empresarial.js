...
var services = [];
var empresarialSvc = new empresarialService();

// carga inicial de datos
empresarialSvc.getServices().then(function (res) {
  services = res.data;
...
function showServices(service){
  ...
  var htmlService = service.empresarial;
  ...
  Object.keys(htmlService).forEach(function(key) {
    ...
    var empreImg   = htmlService[key].empreImg;
    var description = htmlService[key].description;
      ...
      serviceItemContentImg.setAttribute('src', empreImg);
