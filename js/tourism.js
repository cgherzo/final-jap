...
var services = [];
var tourismSvc = new cityTourService();

// carga inicial de datos
  tourismSvc.getServices().then(function (res) {
  services = res.data;
...
function showServices(service){
  ...
  var services = document.getElementById("tourism");
  var htmlService = service.cityTour;
  ...
  Object.keys(htmlService).forEach(function(key) {
    ...
    var cityImg   = htmlService[key].cityImg;
    var description = htmlService[key].description;
      ...
      serviceItemContentImg.setAttribute('src', cityImg);
